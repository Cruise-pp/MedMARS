...
def main():
    csv_path = str(_BASE_DIR / "Datasets/MedQuAD.csv")
    try:
    ...
    os.makedirs(_BASE_DIR / "processed/medquad", exist_ok=True)
    ...
    faiss.write_index(index, str(_BASE_DIR / "processed/medquad/medquad_index.faiss"))

    with open(str(_BASE_DIR / "processed/medquad/medquad_corpus.jsonl"), "w", encoding="utf-8") as f:
